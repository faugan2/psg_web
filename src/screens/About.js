...
import oldLadyStadium from "../components/img/old_lady_stadium.png";
import baseball from "../components/img/baseball.jpeg";
import crowd from "../components/img/crowd.jpeg";
...
const sections = [
    {
        ...
        We believe what really makes sports so special in our lives is the ability to enjoy the game without risking money. We care about the people and their pockets too. 
        ProSport.Guru sports Pick’em game allows you and your friends to enjoy sports in a fun and social way that creates eternal memories without burning down your pockets!   
    ...
    },
    {
        title: "Our Ambition",
        contents: [
            `It’s simple, to bring a revolution by providing the same thrill and excitement to the people by playing the pick 'em sports game without risking a penny!
    ...
    },
    {
        title: "Our Story",
        contents: [
            `It all started with an ultimate love for fantasy sports Pick’ Em games.
        ...
        Redefining the idea of fantasy sports pick’em games and bringing in a revolution in the gaming industry was our utmost mission.`,
            `Currently, ProSport.Guru, the game they launched from the bedroom in Craig Weissenfels’s apartment, is now known for the way that it revolutionized fantasy sports pick’em games. And, this is how we brought thrill, amazement, and excitement to your fingertips!        
    ...
    {
        title: "Craig Weissenfels- The Man That Made It Possible!",
        contents: [
            `CEO Of ProSport.Guru 
        With over 15 years of strategic business experience, he always had an ultimate love for sports. Being an efficient sports player and lover throughout his life, he chose to amalgamate his love for sports & the spirit of success in his career. With a little exposure to the fantasy world and great affection for sports, he curated ProSport.Guru - the leading fantasy pick’em game.
        Since birth, instead of blood, it was love for sports that was running into his veins. Once he grew up his only mission was to run his own global sports company. It’s just a tip of an iceberg, apart from this Craig has worked for one of the world’s largest sports entertainment companies. On top of that, he received the Maple Leaf Sports and Entertainment Rookie award in 2000. He started as a three-legged frog but with the ability to overcome all the obstacles he is now turned into a prosperity toad!`,
            `Fogan Bidi an Asset of the ProSport.Guru
        CTO and Software engineer of ProSport.Guru
        Fogan Bidi is the young and dynamic software engineer of ProSport.Guru. He constantly contributed towards the development of the app. With him by our side, we developed the #1 Pick’em game.
        With all the expertise he self-trained himself to learn new technologies to offer his valuable services to ProSport.Guru. He ensures the successful implementation of the ProSport.Guru’s business mission through continuously delivering cutting-edge and innovative experiences to all the sports fans.
        `,
        ],
        image: oldLadyCoins,
    },
    ...
    {
        title: "What Makes ProSpot.Guru Unique? - Introducing the PS.G Crypto Coins",
        contents: [
            `The PS.G Crypto Coins - Honey, Why to Risk Money When You Have PS.G Crypto Coins?
        ...
        Join our amazing community to experience the non-stop excitement by picking and playing games, but without risking! 
        `,
        ],
        image: oldLadyStadium,
        right: true,
    },
    {
        title: "Interested in Partnering With Us?",
        contents: [
            `We are #1 Pick’em sports game is best than hundreds out there. We strive to make a fantasy sport online gaming experience full of excitement among the sports lovers. This is what we look forward to achieving. 
        We are obsessively excited about it and it is our goal to please our gamers, both beginners or professionals. We offer them a platform to groom their picking skills as well as get their way to win, and be entertained thoroughly. Our motto is to give heart pounding thrilling experiences to your sports fans. It is no joke that ProSport.Guru is now revolutionizing the whole online gaming industry. Joining hands with us can surely turnout into a great outcome. Let’s join hands to conquer! 
        `,
        ],
        image: crowd,
    },
