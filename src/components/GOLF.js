        ...
        <div role="tabpanel" className="tab-pane" id="GOLF">
         <div className="row">
          <div className="col-md-6 col-sm-12">
            <h3>Golf - Pick Your Format and Add the Exclusive Excitement to the Games!</h3>
            <h4>Now You Can Enjoy the Excitement of Playing Golf with 5 Different Game Modes!</h4>
            <div style={{marginBottom:"20px"}}>
            <p>Let &nbsp;ProSport.Guru add exclusive excitement to your Golf game. 
