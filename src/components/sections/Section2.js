import "../../styles/sections/section2.scss";
            ...
            <div className="how_lines">
                <div className="how_line">
                    ...
                    <div className="how_line_info">
                        ...
                        <p>
                            Select from a list of public games or invite friends
                            and family
                        </p>
                    </div>
                </div>
                <div className="how_line">
                    ...
                    <div>
                        ...
                        <p>
                            Pick your games based on point spread and/or total
                            game score. Most wins or longest winning streak of
                            3,5,7 or 9 games
                        </p>
                    </div>
                </div>
                <div className="how_line">
                    ...
                    <div>
                        ...
                        <p>
                            Compete to build your profile rating and stay at the
                            top of the leader board. Collect coins and win
                            prizes.
                        </p>
                    </div>
                </div>
